...
const Navber = () => {
  ...
  useEffect(() => {
    // Update cart count when the component mounts or when cart data changes
  ...
  return (
    <Fragment>
      {/* Navber Section */}
      <nav  style={{height:""}} className="fixed top-0 w-full z-20 shadow-lg bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3 items-center"> {/* Modified line */}
          ...
          <div style={{width:"480px"}} className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
            style={{ fontSize: "18px" }}
